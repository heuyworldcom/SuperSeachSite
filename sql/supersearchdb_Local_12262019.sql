...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2019 at 05:42 AM
...
DROP TABLE IF EXISTS `menu_prefixes`;
...
DROP TABLE IF EXISTS `supersearch`;
...
(17, 1, '2019-12-27 05:12:15', 1, 'test', 'https://www.google.com/search?', 'test', 'test');
