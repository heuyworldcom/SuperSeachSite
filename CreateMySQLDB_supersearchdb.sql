...
CREATE TABLE `main_menu` (
  ...
  `sort_ord` int(11) NOT NULL,
  `menu_prefix_id` int(11) NOT NULL,
  `main_menu_name` varchar(50) NOT NULL,
  `main_menu_url` varchar(25) DEFAULT NULL,
...
INSERT INTO `main_menu` (`main_menu_id`, `sort_ord`, `menu_prefix_id`, `main_menu_name`, `main_menu_url`, `active`) VALUES
(2, 1, 1, 'Home', NULL, 1),
(3, 2, 1, 'View Searches', NULL, 1),
(4, 3, 1, 'Create Search', NULL, 1),
(5, 4, 1, 'Create Account', NULL, 1),
(6, 5, 1, 'Help', NULL, 1);

-- --------------------------------------------------------

--
-- Table structure for table `menu_prefixes`
--

CREATE TABLE `menu_prefixes` (
  `menu_prefix_id` int(11) NOT NULL,
  `menu_prefix` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `menu_prefixes`
--

INSERT INTO `menu_prefixes` (`menu_prefix_id`, `menu_prefix`) VALUES
(1, 'a_section_'),
(2, 'a_sub_section_');
...
CREATE TABLE `sub_menus` (
  ...
  `sub_menu_url` varchar(266) DEFAULT NULL,
  `sub_menu_prefix_id` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `sub_menus` (`sub_menu_id`, `main_menu_id`, `sort_ord`, `sub_menu_name`, `sub_menu_url`, `sub_menu_prefix_id`, `active`) VALUES
(1, 3, 0, 'PHP', NULL, 2, 0),
(2, 2, 2, 'Custom', NULL, 2, 0);
...
(18, 1, '2019-12-27 05:12:10', 1, 'CSS', 'https://www.google.com/search?', 'Things about html5 CSS', 'html5 css'),
(19, 1, '2019-12-27 07:12:13', 1, 'jQuery', 'https://www.google.com/search?', 'Things about jQuery .each iterations', 'jquery each loops'),
(21, 1, '2019-12-27 11:12:59', 1, 'jQuery', 'https://www.google.com/search?', 'Things about jQuery UI', 'jquery ui'),
(22, 1, '2019-12-27 12:12:35', 1, 'mySql Commands', 'https://www.google.com/search?', 'Things about mySql commands', 'mysql commands'),
(23, 1, '2019-12-29 23:12:55', 1, 'Normal Search', 'https://www.google.com/search?', 'Normal Google Search', ' '),
(24, 1, '2020-02-23 09:02:40', 1, 'MySQL General', 'https://www.google.com/search?', 'General things about mysql', 'mysql');
...
--
-- Indexes for table `menu_prefixes`
--
ALTER TABLE `menu_prefixes`
  ADD PRIMARY KEY (`menu_prefix_id`);
...
--
-- AUTO_INCREMENT for table `menu_prefixes`
--
ALTER TABLE `menu_prefixes`
  MODIFY `menu_prefix_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `sub_menus`
--
ALTER TABLE `sub_menus`
  MODIFY `sub_menu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
